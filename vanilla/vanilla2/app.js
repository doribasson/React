...
//from index.html the class -> with ('.class')
//from index.html the id -> with ('#class')
...
function onSubmit(e){
    ...
    if(nameInput.value ==='' || emailInput.value ==='') {
        msg.classList.add('error') //add class error
        ...
        userList.appendChild(li); //dynemecly insert the li to ul..userList is a ul
